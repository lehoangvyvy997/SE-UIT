...
import App from './components/Overview';
import Web from './components/Organization';
import Manage from './components/Course'
       ...
       <StatusBar translucent backgroundColor="rgba(0, 0, 0, 0.2)" />
        ...
        <Container >
          ...
          <Tabs  locked tabBarUnderlineStyle={{borderBottomWidth:2}} renderTabBar={() => <ScrollableTab style={{ height: 70 }} />} >
            ...
            <Tab textStyle={{ color: '#fff' }} activeTextStyle={{ color: 'rgba(255, 87, 34, 0.8);' }} tabStyle={{ backgroundColor: '#282828' }} activeTabStyle={{ backgroundColor: '#14223C' }} heading="Sơ đồ tổ chức">
              <Web />
            </Tab>
            <Tab textStyle={{ color: '#fff' }} activeTextStyle={{ color: 'rgba(255, 87, 34, 0.8);' }} tabStyle={{ backgroundColor: '#282828' }} activeTabStyle={{ backgroundColor: '#14223C' }} heading="Chương trình đào tạo">
              <Manage />
            </Tab>
          </Tabs>
        </Container>
